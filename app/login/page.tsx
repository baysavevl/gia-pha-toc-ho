  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      if (hostname === config.demoDomain) {
        setIsDemo(true);
        setEmail("demo@hovantoc.example");
        setPassword("hovantoc");
      }
    }
  }, []);
        ...
        if (error) {
          ...
          if (data.session) {
            ...
            if (!signInError && signInData.session) {
              ...
              setSuccessMessage(
                "Đăng ký thành công! Vui lòng chờ Ban trị sự kích hoạt tài khoản để xem nội dung.",
              );
          ...
          <div className="text-center mb-8 relative z-10">
            ...
            <p className="mt-3 text-sm text-stone-500 font-medium tracking-wide">
              {isLogin
                ...
                : "Tạo tài khoản thành viên Hồ Văn Tộc."}
            </p>
            {isDemo && (
              <motion.div
